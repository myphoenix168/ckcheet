				...
				<div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
					...
					<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
						...
						<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo39/dist/index.html" action="#">
								<!--begin::Heading-->
								<div class="text-center mb-11">
									<!--begin::Title-->
									<h1 class="text-dark fw-bolder mb-3">ล็อคอินเพื่อใช้งานระบบ</h1>
									<!--end::Title-->
									<!--begin::Subtitle-->
								...
								<div class="fv-row mb-8">
									<!--begin::Username-->
									<input type="text" placeholder="Username" name="username" value="<?php echo old('username'); ?>" autocomplete="off" class="form-control bg-transparent" />
									<!--end::Username-->
								</div>
								<!--end::Input group=-->
								...
								<div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
									<div></div>
									<!--begin::Link-->
									<a href="../../demo39/dist/authentication/layouts/overlay/reset-password.html" class="link-primary">ลืมรหัสผ่าน ?</a>
									<!--end::Link-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Submit button-->
								...
								<div class="text-gray-500 text-center fw-semibold fs-6">Not a Member yet?
									<a href="../../demo39/dist/authentication/layouts/overlay/sign-up.html" class="link-primary">ลงทะเบียน</a>
								</div>
								<!--end::Sign up-->
							</form>
							<!--end::Form-->
